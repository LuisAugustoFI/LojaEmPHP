...
<html lang="pt-br">
  ...
  <body>
  <div class ="container"> 
        <h1>Listagem de Categoria em Tabela</h1>
  ...
  <tbody>
    ...
    <th scope='row'>$id</th>
    <td>$nome</td>
    <td> <a href='frm_altera_categoria.php?id=$id'> <button type='button' class='btn btn-danger'>Editar</button> </a> </td>
    <td> <a href='del_categoria.php?id=$id'> <button type='button' class='btn btn-danger'>Excluir</button> </a> </td>
  </tr>";
